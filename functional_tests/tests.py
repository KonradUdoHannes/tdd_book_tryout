    ...
    def wait_for_row_in_list_table(self,row_text):
        ...
        while True:
            try:
                ...
                if time.time() - start_time >= NewVisitorTest.WAIT_MAX:
                    raise e
                time.sleep(0.5)
...
#if __name__ == '__main__': #only used for unittest.Testcase class, not for Django tests
#    unittest.main()
